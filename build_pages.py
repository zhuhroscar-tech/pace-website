...
{faq_items_html}    </div>
  ...
  <section class="wrap">
    <div class="final-cta" data-reveal="0">
      ...
      <a class="btn btn-primary btn-lg" href="mailto:hello@paceapp.dev">Email us</a>
    </div>
  </section>
</main>
""",
  ...
  <section class="wrap" style="padding-top:56px;">
    ...
    <div class="waitlist-block" data-reveal="1">
      <div class="waitlist-form-wrap">
        <!--
          GOOGLE FORM EMBED — replace the src below with your
          real Google Form's embed URL once created. See
          Downloads/pace-google-form-setup.md for exact field
          setup instructions.
        -->
        <iframe
          src="PASTE_GOOGLE_FORM_EMBED_URL_HERE"
          title="Pace beta waitlist signup form"
          loading="lazy">
          Loading form…
        </iframe>
        <p style="font-size:12.5px;color:var(--text-faint);margin-top:12px;">
          Having trouble with the embedded form? <a href="mailto:hello@paceapp.dev" style="text-decoration:underline;">Email us directly</a> instead.
        </p>
      </div>
    </div>
  </section>
